...
- [Removing orphaned webhook configs](devops/kubernetes/validatingwebhookconfigurations.md)
- [Understanding parentRef](devops/kubernetes/parentref.md)
- [Debuggin endpoints with gateway api](devops/kubernetes/endpoint-fix.md)

  #### Monitoring

  - [Understanding kube alerts](/devops/kubernetes/monitoring/kube-alerts.md)
  - [PrometheusRulesReceivers](/devops/kubernetes/monitoring/prom-rules-receiver.md)
  - [Writing good PrometheusRules](/devops/kubernetes/monitoring/promrules.md)
...
- [`slices` package](/go/slices_package.md)
- [Maps in Go](/go/maps.md)
- [Structs in Go](/go/structs.md)
- [Pointers in Go](/go/pointers.md)
- [Understanding Go functions](/go/understanding_funcs.md)
- [Go routines and channels](/go/goroutines_channels.md)
- [Go routines in more detail](/go/goroutines_moreinfo.md)
- [Sequential vs Go routines](/go/seq_vs_gor.md)
- [Work groups in Go](/go/workgroups.md)
- [String formatting](/go/string_formatting.md)
- [The ST1021 warning for exported types](/go/st1021.md)
- [Creating packages and modules](/go/creating_and_accessing_pkgs.md)
...
- [Looping with Bash](terminal/bash/loops.md)
...
- [Anchors](yaml/anchors.md)
- [Multiline strings](yaml/multiline-strings.md)
